...
ยินดีต้อนรับสู่สัปดาห์ที่ 7 ของวิชา ENGCE301 การออกแบบและพัฒนาซอฟต์แวร์! ในสัปดาห์นี้เราจะเจาะลึกเข้าสู่โลกของ Modern JavaScript และการสร้าง Dynamic Web Applications ที่ตอบสนองต่อผู้ใช้แบบ Real-time
...
### Part1: [สร้างแอปพลิเคชันค้นหาสภาพอากาศ (Weather App)](part1)

### Part2: [อัปเกรด Weather App ด้วย Local Storage และ Git Flow](part1)
