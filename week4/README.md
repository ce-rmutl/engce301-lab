...
### **Lab 1.1: สร้างหน้าเว็บแนะนำตัวด้วย HTML พื้นฐาน (1.5 ชั่วโมง) [รายละเอียด](basic-html.md)**

  - **เป้าหมาย:** ฝึกใช้ HTML Tags พื้นฐานเพื่อสร้างโครงสร้างเว็บไซต์ที่มีเนื้อหาครบถ้วน.

### **Lab 1.2: ตกแต่งหน้าเว็บด้วย CSS สีสันสวยงาม (1.5 ชั่วโมง) [รายละเอียด](css-basic.md)**

  - **เป้าหมาย:** นำความรู้ CSS มาใช้ในการตกแต่งหน้าเว็บที่สร้างใน Lab 1.1 ให้สวยงามและน่าสนใจยิ่งขึ้น.

### **Lab 1.3: ปรับให้เว็บไซต์แสดงผลดีบนมือถือ (1 ชั่วโมง) [รายละเอียด](responsive-design.md)**
