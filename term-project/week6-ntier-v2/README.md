# 🐳 คู่มือปฏิบัติการ ENGCE301 - สัปดาห์ที่ 6
...
```bash
# สร้างโฟลเดอร์หลัก
mkdir -p ~/ENGCE301-labs/week6-ntier-docker
cd ~/ENGCE301-labs/week6-ntier-docker
...
cat > api/package.json << 'EOF'
{
  ...
  "version": "2.0.0",
  "description": "ENGCE301 Week 6 - N-Tier Architecture with Docker",
  "main": "server.js",
  "scripts": {
...
# ตั้งค่า metadata
LABEL maintainer="ENGCE301 Student"
...
<body>
    <div class="container">
        ...
        <!-- Footer -->
        <footer class="footer">
            <p>ENGCE301 Software Architecture - Week 6 Docker Version</p>
