...
- [Final Lab — ชุดที่ 2: Microservices Scale-Up + Cloud Deploy (Railway)](#final-lab--ชุดที่-2-microservices-scale-up--cloud-deploy-railway)
  - [สารบัญ](#สารบัญ)
  - [1. ภาพรวมและวัตถุประสงค์](#1-ภาพรวมและวัตถุประสงค์)
    - [การแบ่งเวลาแนะนำ (4 ชั่วโมง)](#การแบ่งเวลาแนะนำ-4-ชั่วโมง)
    - [วัตถุประสงค์การเรียนรู้](#วัตถุประสงค์การเรียนรู้)
  - [2. สถาปัตยกรรมใหม่ (Set 2)](#2-สถาปัตยกรรมใหม่-set-2)
    - [ความแตกต่างจาก Set 1](#ความแตกต่างจาก-set-1)
  - [3. Phase 1: ปรับ Architecture ให้ทำงาน Local](#3-phase-1-ปรับ-architecture-ให้ทำงาน-local)
    - [User Service — Endpoints ที่ต้องมี](#user-service--endpoints-ที่ต้องมี)
    - [DB Schema สำหรับ Set 2](#db-schema-สำหรับ-set-2)
    - [docker-compose.yml สำหรับ Local Test](#docker-composeyml-สำหรับ-local-test)
  ...
  - [7. Phase 5: Gateway Strategy](#7-phase-5-gateway-strategy)
    - [ข้อกำหนด Gateway (ทุก Option)](#ข้อกำหนด-gateway-ทุก-option)
  - [8. Phase 6: Test Cases และ Screenshots](#8-phase-6-test-cases-และ-screenshots)
    - [Test Cases](#test-cases)
    - [โครงสร้าง screenshots/](#โครงสร้าง-screenshots)
