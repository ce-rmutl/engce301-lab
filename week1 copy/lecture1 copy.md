...
## 9. กิจกรรมและการประเมินเฉพาะสัปดาห์ที่ 1 (ฝั่งทฤษฎี)

> ปฏิบัติ (แลบ) อ้างอิงจากเอกสาร `LAB1_ENGCE301.md` ที่เตรียมไว้แล้ว

### 9.1 กิจกรรมในห้องเรียน (ทฤษฎี 2 ชม.)

1. **Mini Lecture:**

   * แนะนำ SE, SWEBOK, SDLC, ISO/IEC/IEEE 12207 แบบภาพรวม
   * เปรียบเทียบ Programming vs Software Engineering ด้วยตาราง/infographic

2. **Infographic & Group Discussion:**

   * แจก template ASCII หรือกระดาษให้กลุ่มวาด

     * SDLC basic diagram
     * Waterfall vs Agile comparison
   * ให้แต่ละกลุ่ม present สั้น ๆ (1–2 นาที)

3. **Career Reflection:**

   * ให้นักศึกษาเลือกบทบาทที่สนใจ (Dev / QA / DevOps / Architect / PO ฯลฯ)
   * เขียน reflection สั้น ๆ 1–2 ย่อหน้า
   * เก็บเป็น evidence CLO6

### 9.2 การประเมินสัปดาห์ที่ 1 (ด้านทฤษฎี)

* **Mini Quiz (ไม่เกิน 10 ข้อ)**

  * ความหมาย SE, SDLC steps, การเปรียบเทียบ Waterfall vs Agile
* **ตรวจเนื้อหาใน Lab 1 ที่สะท้อนความเข้าใจทฤษฎี**

  * ไฟล์ `SE_INTRO_NOTES.md` (บทบาท SE, SDLC diagram, ตาราง Waterfall vs Agile)
  * Reflection เกี่ยวกับ DevTools ใน `README.md`
