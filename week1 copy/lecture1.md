...
## 9. วิธีสอนและการประเมินในสัปดาห์ที่ 1 (เชิงแนวคิด)

### 9.1 ตัวอย่างกิจกรรมในคาบทฤษฎี

1. **Mini Lecture + Discussion**

   * แนะนำ Software Engineering + SDLC
   * ยกกรณีศึกษาซอฟต์แวร์ล้มเหลว (เช่น ระบบการเงิน/จรวด/ทางการแพทย์) เพื่อให้เห็นความสำคัญของกระบวนการและมาตรฐาน

2. **กิจกรรมกลุ่ม: Programmer vs Software Engineer**

   * ให้แต่ละกลุ่มเติมตารางเปรียบเทียบเอง (คิดจากประสบการณ์/จินตนาการ) แล้วค่อยเฉลยด้วยเวอร์ชันของอาจารย์

3. **กิจกรรม Kanban/Backlog สำหรับ Term Project**

   * ให้กลุ่มร่าง Backlog 3–5 งานแรกของ Term Project
   * วาด mini Kanban board (Backlog → To Do → Doing → Done)

4. **Reflection ส่วนตัว**

   * ให้ นศ. เขียนสั้น ๆ ว่า

     * อยากเป็นบทบาทไหนในทีมซอฟต์แวร์
     * อยากใช้ 2–3 ปีข้างหน้าเรียนรู้อะไร

### 9.2 การประเมิน (เชื่อมกับ Lab 1)

* Mini Quiz (5–10 ข้อ) เกี่ยวกับ

  * ความหมาย SE
  * SDLC เฟสต่าง ๆ
  * ความแตกต่าง Waterfall vs Agile
* การตรวจ **Lab 1**

  * Environment setup
  * Git repo + DevTools evidence
  * SE_INTRO_NOTES.md (บทบาท SE, SDLC, Waterfall vs Agile)

---

## 10. สรุปภาพรวมสัปดาห์ที่ 1

**Key Takeaways**

1. ซอฟต์แวร์ในโลกจริง = ระบบที่ซับซ้อน มีผู้ใช้จำนวนมาก และต้องดูแลระยะยาว
2. Software Engineering = การนำแนวคิดวิศวกรรมมาใช้กับการพัฒนาซอฟต์แวร์ทั้งวงจรชีวิต
3. SDLC ให้กรอบ “ขั้นตอน” ส่วนมาตรฐานอย่าง SWEBOK / ISO/IEC/IEEE ให้ “กรอบเนื้อหา/กระบวนการ”
4. Waterfall vs Agile มีจุดแข็ง–จุดอ่อนต่างกัน → เลือกใช้หรือผสมตามบริบท
5. ทีมซอฟต์แวร์ประกอบด้วยหลายบทบาท (Dev, QA, DevOps, PO ฯลฯ) ที่ต้องทำงานร่วมกัน
6. เครื่องมือพื้นฐาน (Git, VS Code, Node.js, DevTools) เป็น “ภาษากลาง” ของนักพัฒนายุคปัจจุบัน
7. ทุกอย่างในสัปดาห์นี้จะถูกนำไปใช้ต่อใน Term Project ทั้งเทอม

*จบเนื้อหาทฤษฎีสัปดาห์ที่ 1 – สามารถแตกเป็นสไลด์ 10–20 หน้า หรือใช้เป็นเอกสารประกอบการสอน/มคอ.3 ได้*
